...
helm install app-staging --namespace staging ./staging/ -f ./staging/values.yaml
...
curl -X POST -H "Content-Type: application/json" -d '{"username":"admin","password":"a"}' http://34.253.0.239:31500/api/login
